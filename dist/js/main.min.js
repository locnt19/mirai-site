...
$(document).ready(function () {
  ...
  var previousScroll = document.documentElement.scrollTop; // Modal chi tiet don hang

  var modal = document.querySelector('.modal-container.ct-donhang__modal');
  var btn_open_modal = document.querySelector('.modal-btn__open.ct-donhang__btn__ungtuyen');
  var btn_close_modal = document.querySelector('.modal-btn__close.ct-donhang__btn__close');
  ...
  var ds_donhang__dropdown = document.getElementById('ds_donhang__dropdown');
  var ds_donhang__list = document.getElementById('ds_donhang__list');
  ...
  var lien_he__dropdown = document.getElementById('lien_he__dropdown');
  var lien_he__list = document.getElementById('lien_he__list');
  ...
  var homeVideoRight = new Swiper('.home-video .right', {
  ...
  var tuyenSinhBanerRight = new Swiper('.tuyensinh-banner .swiper-container.right', {
    effect: 'coverflow',
    speed: 2500,
    coverflowEffect: {
      rotate: 50,
  ...
  var hoiDapSideBarItem = document.querySelectorAll('.hoi-dap .sidebar li');
  var hoiDapTabs = document.querySelectorAll('.hoi-dap [tab]');
  var hoiDapSubTitle = document.querySelector('.hoi-dap .sub-title');
  hoiDapSideBarItem.forEach(function (item) {
    item.addEventListener('click', function () {
      hoiDapTabs.forEach(function (tab) {
